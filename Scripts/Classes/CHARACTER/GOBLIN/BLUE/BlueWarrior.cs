...
public class BlueWarrior : BlueGoblin
{
    const string PathGoblinObj = "GameAssetInScene/ITEM/ENEMY/WARRIOR/BLUE";
    public BlueWarrior(GameObject _ReferenceBlueWarrior)
    {
        this.SetType("BlueWarrior");
        this.LoadAssets(this.GetType(), PathGoblinObj);
        this.SetDamage(this.GetDamage() + 40);
        this.SetGoblinFeatures(_ReferenceBlueWarrior);
        this.UnLoadAssets();
    }
    ...
    protected override void AdjustDamage()
    {
        switch (this.GetLevel())
        {
            case 0:
                ...
                break;
            case 1:
                this.SetDamage(this.GetDamage() + 18 * 1);
                break;
            case 2:
                this.SetDamage(this.GetDamage() + 18 * 2);
                break;
            case 3:
                this.SetDamage(this.GetDamage() + 18 * 3);
                break;
            case 4:
                this.SetDamage(this.GetDamage() + 18 * 4);
                break;
            case 5:
                this.SetDamage(this.GetDamage() + 18 * 5);
                break;
            default:
                break;
        }
