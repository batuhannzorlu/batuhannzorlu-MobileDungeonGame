...
public class GreenWitchdoctor : GreenGoblin
{
    const string PathGoblinObj = "GameAssetInScene/ITEM/ENEMY/WITCHDOCTOR/GREEN";
    public GreenWitchdoctor(GameObject _ReferenceGreenWitchdoctor)
    {
        this.SetType("GreenWitchdoctor");
        this.LoadAssets(this.GetType(), PathGoblinObj);
        this.SetDamage(this.GetDamage() + 10);
        this.SetGoblinFeatures(_ReferenceGreenWitchdoctor);
        this.UnLoadAssets();
    }
    ...
    protected override void AdjustDamage()
    {
        switch (this.GetLevel())
        {
            case 0:
                ...
                break;
            case 1:
                this.SetDamage(this.GetDamage() + 7 * 1);
                break;
            case 2:
                this.SetDamage(this.GetDamage() + 7 * 2);
                break;
            case 3:
                this.SetDamage(this.GetDamage() + 7 * 3);
                break;
            case 4:
                this.SetDamage(this.GetDamage() + 7 * 4);
                break;
            case 5:
                this.SetDamage(this.GetDamage() + 7 * 5);
                break;
            default:
                break;
        }
