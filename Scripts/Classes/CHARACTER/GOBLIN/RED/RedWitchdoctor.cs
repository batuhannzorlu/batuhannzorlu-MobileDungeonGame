...
public class RedWitchdoctor : RedGoblin
{

    const string PathGoblinObj = "GameAssetInScene/ITEM/ENEMY/WITCHDOCTOR/RED";

    public RedWitchdoctor(GameObject _ReferenceRedWitchdoctor)
    {
        this.SetType("RedWitchdoctor");
        this.LoadAssets(this.GetType(), PathGoblinObj);
        this.SetDamage(this.GetDamage() + 30);
        this.SetGoblinFeatures(_ReferenceRedWitchdoctor);
        this.UnLoadAssets();
    }
    ...
    protected override void AdjustDamage()
    {
        switch (this.GetLevel())
        {
            case 0:
                ...
                break;
            case 1:
                this.SetDamage(this.GetDamage() + 21 * 1);
                break;
            case 2:
                this.SetDamage(this.GetDamage() + 21 * 2);
                break;
            case 3:
                this.SetDamage(this.GetDamage() + 21 * 3);
                break;
            case 4:
                this.SetDamage(this.GetDamage() + 21 * 4);
                break;
            case 5:
                this.SetDamage(this.GetDamage() + 21 * 5);
                break;
            default:
                break;
        }
