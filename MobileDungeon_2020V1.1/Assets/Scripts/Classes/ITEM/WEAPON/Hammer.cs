...
namespace Assets.Scripts.Classes
{
    public class Hammer : Weapon
    {
        ...
        const string PathArmorImg = "GameAssetInScene/ItemSprite/Hammers";

        private float FireAmount { get; set; }
        private float FirePercentage { get; set; }

        public Hammer(GameObject _ReferenceHammer)
        {
            const string PathArmorObj = "GameAssetInScene/ITEM/WEAPON/HAMMER/ONDROP";
            this.SetType("Hammer");
            this.LoadAssets(this.GetType(), PathArmorObj, PathArmorImg);
            this.IsCaptured = false;
            this.SetWeaponFeatures(_ReferenceHammer);
            this.UnLoadAssets();
        }

        public Hammer()
        {
            const string PathArmorObj = "GameAssetInScene/ITEM/WEAPON/HAMMER/ONPLAYER";
            this.SetType("Hammer");
            this.LoadAssets(this.GetType(), PathArmorObj, PathArmorImg);
        ...
        override public GameObject GetDefaultWeapon()
        {
            ...
            return (GameObject)(Resources.Load("GameAssetInScene/ITEM/WEAPON/HAMMER/ONPLAYER/weapon_hammer_bronze_1 Variant"));
        }
