...
public class GreenWarrior : GreenGoblin
{
    const string PathGoblinObj = "GameAssetInScene/ITEM/ENEMY/WARRIOR/GREEN";
    public GreenWarrior(GameObject _ReferenceGreenWarrior)
    {
