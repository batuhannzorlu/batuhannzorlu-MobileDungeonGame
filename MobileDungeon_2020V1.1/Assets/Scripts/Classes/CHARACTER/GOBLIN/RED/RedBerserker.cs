...
public class RedBerserker : RedGoblin
{
    const string PathGoblinObj = "GameAssetInScene/ITEM/ENEMY/BERSERKER/RED";
    public RedBerserker(GameObject _ReferenceRedBerserker)
    {
        this.SetType("RedBerserker");
        this.LoadAssets(this.GetType(), PathGoblinObj);
        this.SetGoblinFeatures(_ReferenceRedBerserker);
        this.UnLoadAssets();
    }   
    ...
    protected override void AdjustDamage()
    {
        switch (this.GetLevel())
        {
            case 0:
                ...
                break;
            case 1:
                this.SetDamage(this.GetDamage() + 15*1);
                break;
            case 2:
                this.SetDamage(this.GetDamage() + 15 * 2);
                break;
            case 3:
                this.SetDamage(this.GetDamage() + 15 * 3);
                break;
            case 4:
                this.SetDamage(this.GetDamage() + 15 * 4);
                break;
            case 5:
                this.SetDamage(this.GetDamage() + 15 * 5);
                break;
            default:
                break;
        }
